...
{
    int16_t result = -1;
    uint16_t *alloc_res = 0;
    char_t *alloc_res_char = 0;
    char_t *alloc_res_char2 = 0;
    char_t *alloc_res_char3 = 0;
    ...
    char_t *alloc_new = "New allocation";     // 14
    char_t *alloc_clear = "Clear allocation"; // 16
    uint16_t offset = 0;
    uint16_t x1 = 0;
    uint16_t y1 = 32;
    uint16_t x2 = 70;
    ...
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 5, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_new, 14);
    alloc_res_char = (char_t *)(void *)pIVrtMem->pVTbl->Alloc(pIVrtMem, 0, 4);
    alloc_res_char[0] = 'a';
    alloc_res_char[1] = 'b';
    alloc_res_char[2] = 'c';
    alloc_res_char[3] = 'd';
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 6, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char, 4);
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 7, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_clear, 16);
    pIVrtMem->pVTbl->Free(pIVrtMem, alloc_res_char);

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 8, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_new, 14);
    alloc_res_char = (char_t *)(void *)pIVrtMem->pVTbl->Alloc(pIVrtMem, 0, 4);
    alloc_res_char[0] = 'a';
    alloc_res_char[1] = 'b';
    alloc_res_char[2] = 'c';
    alloc_res_char[3] = 'd';
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 9, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char, 4);
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 10, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_clear, 16);
    pIVrtMem->pVTbl->Free(pIVrtMem, alloc_res_char);

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 11, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_new, 14);
    alloc_res_char = (char_t *)(void *)pIVrtMem->pVTbl->Alloc(pIVrtMem, 0, 100);
    for (i = 0; i < 100; i++)
    {
        alloc_res_char[i] = 'a';
    }
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 12, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char, 10); // для сокращения вывода

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 13, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_new, 14);
    alloc_res_char2 = (char_t *)(void *)pIVrtMem->pVTbl->Alloc(pIVrtMem, 0, 10);
    for (i = 0; i < 10; i++)
    {
        alloc_res_char2[i] = 'b';
    }
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 14, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char2, 10); // для сокращения вывода

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 15, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_new, 14);
    alloc_res_char3 = (char_t *)(void *)pIVrtMem->pVTbl->Alloc(pIVrtMem, 0, 10);
    for (i = 0; i < 10; i++)
    {
        alloc_res_char3[i] = 'c';
    }
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 16, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char3, 10); // для сокращения вывода

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 17, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char, 10); // для сокращения вывода
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 18, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char2, 10);
    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 19, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_res_char3, 10);

    pIVideo->pVTbl->WriteString(pIVideo, 0, 0, 0, 20, CHARACTER_ATTRIBUTE_FORE_COLOR_WHITTE, alloc_clear, 16);
    pIVrtMem->pVTbl->Free(pIVrtMem, alloc_res_char);
    pIVrtMem->pVTbl->Free(pIVrtMem, alloc_res_char2);
    pIVrtMem->pVTbl->Free(pIVrtMem, alloc_res_char3);
